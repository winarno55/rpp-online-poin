...
const emptyForm: LessonPlanInput = {
    ...
    materi: "", jumlahPertemuan: "1 Kali Pertemuan", jamPelajaran: "", pesertaDidik: "", dimensiProfilLulusan: [],
                ...
                <div className="flex-1 flex flex-col items-center justify-center py-12">
                    <div className="max-w-4xl w-full">
                        <div className="text-center mb-10">
                            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-800 text-xs font-bold mb-4 animate-pulse shadow-sm">
