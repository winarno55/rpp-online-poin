    ...
    return (
        <div className="flex justify-center items-center py-12">
            <div className="w-full max-w-md bg-white shadow-2xl rounded-xl p-8 border border-slate-200">
                <h2 className="text-3xl font-bold text-center text-slate-800 mb-6">Lupa Password</h2>
                <p className="text-center text-slate-600 mb-6">Masukkan email Anda untuk menerima tautan reset password.</p>
                ...
                <p className="text-center text-slate-500 mt-6">
                    Ingat password Anda? <Link to="/login" className="font-medium text-sky-600 hover:underline">Login di sini</Link>
                </p>
            </div>
        </div>
    );
