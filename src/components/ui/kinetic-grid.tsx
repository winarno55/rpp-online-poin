...
// ─── Simple local classname helper to avoid external library issues ───────────
    ...
    (now: number) => {
      ...
      const theme = {
        default: {
          ...
          glow: "74,158,255",
          ripple: "100,180,255",
          staticDots: "rgba(255,255,255,0.05)"
        },
        monochrome: {
          bg: "#000000",
          lineBase: { r: 255, g: 255, b: 255, a: 0.13 },
        ...
        light: {
          bg: "#f8fafc",
          lineBase: { r: 15, g: 23, b: 42, a: 0.05 },
          lineActive: { r: 14, g: 165, b: 233, a: 0.7 },
          nodeActive: { r: 14, g: 165, b: 233, a: 1.0 },
          glow: "14,165,233",
          ripple: "14,165,233",
          staticDots: "rgba(15,23,42,0.03)"
        }
      }[globalColor ?? "default"];
      ...
      ctx.fillStyle = theme.staticDots;
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          ctx.fillStyle = lerpColor(
            globalColor === "light" ? { r: 15, g: 23, b: 42, a: 0.1 } : { r: 255, g: 255, b: 255, a: 0.2 },
            theme.nodeActive,
            t,
          );
          ctx.fill();
